        ...
                items = await response.json();
                ...
                for (const trip_name in dictionaryOfData){ 
                    ...
                    for (const day_thingy in names_by_day){
                        ...
                        try{
                            eachRow += "<td align='center' rowspan =" +length + ">" + "<form action='scheduler_ms/google_direction_sg.php' method='post'> <button type='submit' name='data' class='btn btn-dark btn-lg' value="+'"'+names_of_place.join("splitter")+'"'+">View Route</button> </form>" + "</td>" +
